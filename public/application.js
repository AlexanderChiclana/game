...
var sendFailure = function sendFailure(error) {
...
// for moves
var moveSuccess = function moveSuccess(data) {

  // console.log('moveSuccess ran and heres the data: ', data)
};

var moveFailure = function moveFailure(error) {
  console.error('moveFailure ran. Error is :', error);
};

var doneSuccess = function doneSuccess(data) {
  // console.log('doneSuccess ran. Data is :', data)
};

var doneFailure = function doneFailure(error) {
...
var onGetFailure = function onGetFailure(err) {
  console.error(err);
};
...
var tieCheck = function tieCheck() {
  if (bank.length === 0) {
    ...
    gameOver().then(ui.doneSuccess).catch(ui.doneFailure);
    $('#newGame').click();
  } else {}
};
...
var winCheck = function winCheck() {
  ...
  var firstRowStr = firstRow.toString();
  var secondRowStr = secondRow.toString();
  var thirdRowStr = thirdRow.toString();

  var firstColStr = firstCol.toString();
  var secondColStr = secondCol.toString();
  var thirdColStr = thirdCol.toString();

  var diagTopStr = diagTop.toString();
  var diagBotStr = diagBot.toString();

  var xWins = 'x,x,x';
  var oWins = 'o,o,o';

  // shorter logic attempt, checking if won condition met
  if (firstRowStr === xWins || secondRowStr === xWins || thirdRowStr === xWins || firstColStr === xWins || secondColStr === xWins || thirdColStr === xWins || diagTopStr === xWins || diagBotStr === xWins) {
    ...
    gameOver().then(ui.doneSuccess).catch(ui.doneFailure);
    $('#newGame').click();
  } else if (firstRowStr === oWins || secondRowStr === oWins || thirdRowStr === oWins || firstColStr === oWins || secondColStr === oWins || thirdColStr === oWins || diagTopStr === oWins || diagBotStr === oWins) {
...
var sendGame = function sendGame(index, value) {
  bank.shift();
  winCheck();
  return $.ajax({
...
$(function () {
  ...
  $('#B0').on('click', function () {
    ...
    if ($('#B0').is(':empty')) {
      ...
      // code for API
      sendGame(0, bank[0]).then(ui.moveSuccess).catch(ui.moveFailure);
      // winCheck()
      // bank.shift()
    } else {
        // console.log('full')
  ...
  $('#B1').on('click', function () {
    ...
    if ($('#B1').is(':empty')) {
      ...
      sendGame(1, bank[0]).then(ui.moveSuccess).catch(ui.moveFailure);
      // winCheck()
  ...
  $('#B2').on('click', function () {
    ...
    if ($('#B2').is(':empty')) {
      ...
      sendGame(2, bank[0]).then(ui.moveSuccess).catch(ui.moveFailure);
      // winCheck()
  ...
  $('#B3').on('click', function () {
    ...
    if ($('#B3').is(':empty')) {
      ...
      sendGame(3, bank[0]).then(ui.moveSuccess).catch(ui.moveFailure);
      // winCheck()
  ...
  $('#B4').on('click', function () {
    ...
    if ($('#B4').is(':empty')) {
      ...
      sendGame(4, bank[0]).then(ui.moveSuccess).catch(ui.moveFailure);
      // winCheck()
  ...
  $('#B5').on('click', function () {
    ...
    if ($('#B5').is(':empty')) {
      ...
      sendGame(5, bank[0]).then(ui.moveSuccess).catch(ui.moveFailure);
      // winCheck()
  ...
  $('#B6').on('click', function () {
    ...
    if ($('#B6').is(':empty')) {
      ...
      sendGame(6, bank[0]).then(ui.moveSuccess).catch(ui.moveFailure);
      // winCheck()
  ...
  $('#B7').on('click', function () {
    ...
    if ($('#B7').is(':empty')) {
      ...
      sendGame(7, bank[0]).then(ui.moveSuccess).catch(ui.moveFailure);
      // winCheck()
  ...
  $('#B8').on('click', function () {
    ...
    if ($('#B8').is(':empty')) {
      ...
      sendGame(8, bank[0]).then(ui.moveSuccess).catch(ui.moveFailure);
      // winCheck()
  ...
  var outModal = document.getElementById('outState');
...
var onGetGames = function onGetGames(event) {
  event.preventDefault();
  api.index().then(ui.onGetSucess).catch(ui.onGetFailure);
};
